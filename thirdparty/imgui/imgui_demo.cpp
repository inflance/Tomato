...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Querying Item Status (Edited/Active/Hovered etc.)"))
    {
        ...
        if (item_type == 5) { ret = ImGui::InputText("ITEM: InputText", &str[0], IM_ARRAYSIZE(str)); }  // Testing input text (which handleds tabbing)
...
static void ShowDemoWindowTables()
{
    ...
    // This is a simplified version of the "Advanced" example, where we mostly focus on the code necessary to handled sorting.
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        if (ImGui::TreeNode("Mouse cursors"))
        {
            ...
            ImGui::SameLine(); HelpMarker(
                ...
                "otherwise your backend needs to handled it.");
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        else
        {
            ...
            // both of which we can handled since we an array pointing to the beginning of each line of text.
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            draw_list->AddRectFilled(ImVec2(x, y), ImVec2(x + sz, y + thickness), col);                             x += sz + spacing;  // Horizontal line (faster than AddLine, but only handled integer thickness)
            draw_list->AddRectFilled(ImVec2(x, y), ImVec2(x + thickness, y + sz), col);                             x += spacing * 2.0f;// Vertical line (faster than AddLine, but only handled integer thickness)
